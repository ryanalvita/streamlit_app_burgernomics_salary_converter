# Streamlit App Burgernomics Salary Converter

Streamlit App to convert salary using the Big Mac Index

Built with ❤️ by [ryanalvita](https://github.com/ryanalvita)
...
git clone git@github.com:ryanalvita/streamlit_app_burgernomics_salary_converter.git

# Go to correct directory
cd streamlit_app_burgernomics_salary_converter
